...
function AutoClaims() {
  ...
  return (
    <div className="min-h-screen bg-[#f8fafc] py-3 px-3 text-[12px] sm:px-2">
      <div className="shadow-sm">
        ...
        <div className="flex items-start justify-between gap-3 xl:flex-col xl:items-start">
          ...
          {/* Right Buttons */}
          <div className="flex items-center gap-2 shrink-0 sm:w-full sm:flex-wrap">
            <button
              type="button"
        ...
        {/* Stats */}
        <div className="mt-2">
          <div className="grid grid-cols-5 gap-2 xl:grid-cols-3 lg:grid-cols-2 sm:grid-cols-1">
              ...
              >
                ...
                <div>
                  ...
                  <div className="mt-2">
                    ...
                    <h2 className="mt-[2px] text-[17px] lg:text-[15px] font-bold text-[#111827] break-words leading-none">
                      {item.value}
                    </h2>
                  </div>
                </div>
        ...
        <div className="mt-3 flex flex-col gap-3 xl:flex-row xl:items-center xl:justify-between">
          <div className="flex flex-1 flex-wrap gap-2 md:flex-col">
        ...
        {/* Charts */}
        <div className="mt-2 grid grid-cols-3 gap-2 xl:grid-cols-2 lg:grid-cols-1">
          {/* Chart 1 */}
          <div className="rounded-2xl border border-[#edf0f2] bg-white p-3">
            <h3 className="text-[15px] font-semibold text-[#111827]">Claim Amount by Type</h3>
          ...
          {/* Chart 2 */}
          <div className="rounded-2xl border border-[#edf0f2] bg-white p-3">
            <h3 className="text-[15px] font-semibold text-[#111827]">Claim Status Overview</h3>
          ...
          <div className="rounded-2xl border border-[#edf0f2] bg-white p-3">
            <div className="mb-3 flex items-center justify-between">
              <h3 className="text-[15px] font-semibold text-[#111827]">Claim Amount by Marketplace</h3>
        ...
        <div className="mt-3 rounded-l border border-[#edf0f2] bg-white overflow-hidden">
          ...
          {/* Toolbar */}
          <div className="flex items-center justify-between border-b border-[#edf0f2] px-3 py-2 xl:flex-col xl:items-start xl:gap-2">
            {' '}
          ...
          {/* Footer */}
          <div className="flex items-center justify-between px-3 py-2 sm:flex-col sm:gap-2">
