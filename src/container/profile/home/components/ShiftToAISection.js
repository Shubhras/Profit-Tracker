...
//     description: 'Automate order reconciliation across 100+ platforms in seconds, not hours.',
...
//     description: 'Connect with Shopify, WooCommerce, and 100+ other platforms instantly.',
...
const features = [
  ...
  },
  {
    ...
    description: 'Track revenue, costs, and real-time profit from one powerful dashboard.',
    color: 'from-emerald-400 to-teal-500',
    delay: 0.2,
  },
  {
    ...
    description: 'Identify loss-making products and get smart margin improvement tips.',
    color: 'from-purple-400 to-pink-500',
    delay: 0.3,
  },
  {
    ...
    description: 'Connect Shopify, WooCommerce, Amazon, and other sales channels easily.',
    color: 'from-blue-400 to-cyan-500',
    delay: 0.4,
  },
  {
    ...
    description: 'Your financial data is protected with encrypted storage and secure APIs.',
    color: 'from-green-400 to-emerald-500',
    delay: 0.5,
  },
  {
    ...
    description: 'Designed for startups, growing brands, and enterprise sellers.',
    color: 'from-red-400 to-rose-500',
    delay: 0.6,
  },
];
