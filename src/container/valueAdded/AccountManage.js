    ...
    <div className="mb-3 space-y-3 px-4">
      ...
      <div className="shadow-regular px-2 py-2">
        <div className="flex items-start justify-between gap-3 lg:flex-col lg:items-start">
          <div>
            <h1 className="text-[21px] font-semibold text-dark mb-0">Account Management</h1>

            <p className="text-[12px] text-light max-w-[900px] leading-5 mb-1">
              Manage your marketplace accounts efficiently with dedicated account management services. Track
              performance, optimize listings, improve visibility, and grow your business with expert strategies tailored
              for your brand.
            </p>
          </div>
      ...
      <div className="rounded-10 border border-normal bg-white shadow-regular p-3">
        <h3 className="text-[14px] font-semibold text-dark mb-3">Our Marketplaces</h3>

        <div className="grid grid-cols-8 gap-2 xl:grid-cols-4 sm:grid-cols-2">
          {marketplaces.map((item) => (
            <div
              key={item.name}
              className="h-[50px] rounded-10 border border-normal bg-white flex items-center justify-center"
            >
      ...
      <div className="grid grid-cols-4 gap-1 xl:grid-cols-2 lg:grid-cols-1">
        ...
        <div className="col-span-3 xl:col-span-2 lg:col-span-1">
          <div className="bg-white rounded-10 border border-normal shadow-regular p-3">
            <h3 className="text-[15px] font-semibold text-dark mb-3">Account Management Plans</h3>
                ...
                <div className="p-2 flex-1">
                  <div className="flex items-start gap-3 mb-1">
                    <div className="w-11 h-11 rounded-full bg-[#edf4ff] flex items-center justify-center flex-shrink-0">
                      <SafetyCertificateOutlined className="text-[#2563eb] text-[20px]" />
                    </div>
                ...
                <div className="border-t border-[#dbe7ff] px-2 py-3">
                  <div className="flex items-center justify-between gap-3">
                    ...
                    <Button
                      ...
                      onClick={() =>
                        navigate('/admin/pages/support', {
                          state: { openModal: true, title: 'Inquiry for Account Management - Pro Plan' },
                        })
                      }
                      className="bg-[#16a34a] border-[#16a34a] h-[28px] px-3 text-[10px] font-semibold rounded-md flex-shrink-0"
                    >
                ...
                <div className="border-t border-[#eadcff] px-2 py-3">
                  <div className="flex items-center justify-between gap-3">
                    ...
                    <Button
                      ...
                      onClick={() =>
                        navigate('/admin/pages/support', {
                          state: { openModal: true, title: 'Inquiry for Account Management - Premium Plan' },
                        })
                      }
                      className="bg-[#16a34a] border-[#16a34a] h-[28px] px-3 text-[10px] font-semibold rounded-md flex-shrink-0"
                    >
      ...
      <div className="bg-white rounded-10 border border-normal shadow-regular p-4">
        <h3 className="text-[15px] font-semibold text-dark mb-1">Account Management Workflow</h3>
