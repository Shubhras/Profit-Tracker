...
class MyntraAmazonProfitAdapter:
    ...
    def style_row(cls, row, image_maps=None):
        ...
        return {
            ...
            "estimated_commission": cls._money(row.get("estimated_commission") or 0),
            "estimated_fixed_fee": cls._money(row.get("estimated_fixed_fee") or 0),
            "estimated_return_fee": cls._money(row.get("estimated_return_fee") or 0),
            "estimated_marketing_fee": cls._money(row.get("estimated_marketing_fee") or 0),
            "estimated_shipping_fee": cls._money(row.get("estimated_shipping_fee") or 0),
            "other_estimated_fees": cls._money(row.get("other_estimated_fees") or 0),
    ...
    def style_totals(cls, rows):
        ...
        return {
            ...
            "amazon_leaks": cls._money(0),
            "myntra_leaks": cls._money(abs(total_fees_leaks) + abs(total_shipping_leaks) + abs(total_mp_gst_leaks) + abs(total_tcs_leaks) + abs(total_tds_leaks) + abs(total_unsettled_not_paid)),
