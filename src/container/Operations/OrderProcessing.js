    ...
    <div className="min-h-screen bg-[#f8fafc] py-3 px-3">
      <div className="shadow-sm">
        ...
        <div className="flex items-start justify-between lg:flex-col lg:gap-3">
          {' '}
          <div>
            <div className="flex items-center gap-2 lg:w-full lg:flex-wrap">
        ...
        {/* Cards */}
        <div className="mt-2 grid grid-cols-6 gap-2 lg:grid-cols-3 md:grid-cols-2 sm:grid-cols-1">
        ...
        {/* Charts Row */}
        <div className="mt-2 grid grid-cols-[2fr_1.2fr_1fr] gap-2 lg:grid-cols-1">
          {' '}
          {/* Line Chart */}
          ...
          <div className="rounded-2xl border border-[#edf0f2] bg-white p-3">
            ...
            <div className="mt-2 flex items-center justify-between gap-2 md:flex-col">
              <div className="relative h-[220px] w-[220px] md:w-full">
                <ResponsiveContainer width="100%" height="100%">
                  <PieChart>
        ...
        <div className="mt-2 rounded-2xl border border-[#edf0f2] bg-white px-3 py-2">
          ...
          {/* Marketplace Cards */}
          <div className="grid grid-cols-6 gap-2 lg:grid-cols-3 md:grid-cols-2 sm:grid-cols-1">
            {' '}
            {[
              {
        ...
        <div className="mt-2 rounded-2xl border border-[#edf0f2] bg-white">
          {/* Top Filters */}
          <div className="flex items-center justify-between border-b border-[#edf0f2] px-3 py-2 lg:flex-col lg:items-start lg:gap-2">
            {' '}
          ...
          {/* Pagination */}
          <div className="flex items-center justify-between px-3 py-2 md:flex-col md:gap-2">
