  ...
  return (
    <TopMenuStyle>
      <div className="hexadash-top-menu ltr:pl-[20px] rtl:pr-[20px] xl:ltr:pl-[10px] xl:rtl:pr-[10px]">
        <ul>
          <li>
            <NavLink onClick={addParentActive} to={`${path}/pages/actionsrequired`}>
              <UilCheckSquare />
              Actions Required
            </NavLink>
          </li>
          ...
          <li className="has-subMenu">
            ...
            <ul className="subMenu">
              <li>
                <NavLink to={`${path}/profit/summary`} onClick={addParentActive}>
                  Summary
                </NavLink>
              </li>
              <li>
                <NavLink to={`${path}/profit/salesTrend`} onClick={addParentActive}>
                  Sales Trend
                </NavLink>
              </li>
              <li>
                <NavLink to={`${path}/profit/profitTableView`} onClick={addParentActive}>
                  Profit Table View
                </NavLink>
              </li>
              <li>
                <NavLink to={`${path}/profit/profitMonthlyView`} onClick={addParentActive}>
                  Profit Monthly View
                </NavLink>
              </li>
              <li>
                <NavLink to={`${path}/profit/canvasMYOR`} onClick={addParentActive}>
                  Canvas MYOR
                </NavLink>
              </li>
            </ul>
          ...
          <li>
            <NavLink onClick={addParentActive} to={`${path}/pages/download`}>
              <UilCheckSquare />
              Download
            </NavLink>
          </li>
