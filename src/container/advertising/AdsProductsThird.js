...
function AdProductsThird() {
  ...
  const columns = [
...

    {
      ...
      render: (v) => (
        <Tooltip title={v}>
          <span className="block truncate font-medium text-[#2563eb] mx-auto" style={{ maxWidth: '220px' }}>
            {v}
          </span>
        </Tooltip>
      ),
            ...
            <div className="flex items-start justify-between gap-4">
              ...
              <div className="flex items-center gap-4">
                ...
                <div className="flex flex-col">
                  <h1 className="text-[24px] font-semibold text-[#111827] leading-[30px] mb-1">Products Groups</h1>
