...
class ProfitabilityItemDTO:
    ...
    closing_fee: Any = "₹0.0"
    estimated_commission: Any = "₹0.0"
    estimated_fixed_fee: Any = "₹0.0"
    estimated_return_fee: Any = "₹0.0"
    estimated_marketing_fee: Any = "₹0.0"
    estimated_shipping_fee: Any = "₹0.0"
    other_estimated_fees: Any = "₹0.0"
...
class ProfitabilityDTOAdapter:
    ...
    def from_row(row: dict, default_channel: Optional[str] = None) -> ProfitabilityItemDTO:
        ...
        estimated_commission = _format_curr(row.get("estimated_commission"))
        estimated_fixed_fee = _format_curr(row.get("estimated_fixed_fee"))
        estimated_return_fee = _format_curr(row.get("estimated_return_fee"))
        estimated_marketing_fee = _format_curr(row.get("estimated_marketing_fee"))
        estimated_shipping_fee = _format_curr(row.get("estimated_shipping_fee"))
        other_estimated_fees = _format_curr(row.get("other_estimated_fees"))
