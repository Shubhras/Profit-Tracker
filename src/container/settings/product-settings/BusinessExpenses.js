  ...
  return (
    <>
      <div className="p-2 px-3 bg-[#f8fafc] min-h-screen">
        {/* PAGE HEADER */}
        <div className="px-3 xl:px-[15px] pt-2 pb-5">
          <div className="flex items-start justify-between gap-6 lg:flex-col lg:gap-4">
            {' '}
            <div className="text-left">
              <h1 className="text-[24px] font-semibold text-[#1F2937] m-0">Business Expenses</h1>

              <p className="text-[13px] text-[#6B7280] mt-1 max-w-[600px] leading-[20px]">
                Add the costs that never show up in a marketplace report — storage, packaging, manpower, software,
                agency fees. TrackMyProfit spreads each one across your SKUs or orders so your profit reflects what you
                actually spent.
              </p>
            </div>
          ...
          <div className="mt-4 p-3 bg-[#F0F9FF] border border-[#BAE6FD] rounded-[6px] flex items-center gap-2 text-[12px] text-[#0369A1]">
            ...
            <span>
              Fees the marketplace already bills you per order — commission, shipping, RTO — come in through your
              uploaded reports. Add them under Finance Configuration → Upload Marketplace Reports, not here.
            </span>
          </div>
        </div>

        <main className="px-3 xl:px-[15px] pb-[30px]">
                ...
                {lockedCostTypeInfo?.isLocked && (
                  <div className="mb-3 p-2.5 bg-[#EFF6FF] border border-[#BFDBFE] rounded-[6px] flex items-center gap-2 text-[12px] text-[#1E40AF]">
                    ...
                    <span>
                      ...
                      <strong>{lockedCostTypeInfo.costType === 'per_sku' ? 'Per SKU' : 'Per Order'}</strong> based on
                      your existing expenses for this marketplace.
                    </span>
                  </div>
                )}
          ...
          <div className="flex items-start gap-3 mb-3">
            ...
            <div>
              ...
              <p className="text-[13px] text-[#6B7280] mt-1">
                Are you sure you want to delete <strong>{expenseToDelete?.expense_name}</strong>? This action will
                remove it from future profit calculations.
              </p>
            </div>
          </div>
